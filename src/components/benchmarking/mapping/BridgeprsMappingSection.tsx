...
export interface BridgeprsMappingSectionProps {
  /** Job ID */
  jobId: string | null
...
/**
 * BridgeprsMappingSection - Mapping fields for BridgePRS tool
 *
 * Displays target (Pop1) and base (Pop2) population mapping fields.
 */
export function BridgeprsMappingSection({
  jobId,
  mappings,
  onUpdateMapping,
  onUpdatePopulation,
...
export default BridgeprsMappingSection
